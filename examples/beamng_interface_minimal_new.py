import numpy as np
import cv2
from BeamNGRL.BeamNG.beamng_interface_new import *
import traceback
import argparse
...
def main(args):
    ...
    while True:
        try:
            ...
            # print("state: ", state)  ## this is the state information. It is a numpy array of size 15 (3 for position, 3 for orientation, 3 for velocity, 3 for acceleration, 1 for steering angle, and 1 for throttle/brake/reverse)
